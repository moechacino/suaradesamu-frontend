...
import { API_CANDIDATE_GETALL, API_ORGANIZATION_POST_CREATE } from "../env";
  ...
  const handleFormSubmit = async (event: Event) => {
    ...
    try {
      const response = await axios.post(
        `${API_ORGANIZATION_POST_CREATE}/${candidateId}`,
        {
          title,
          periodStart,
          periodEnd,
      ...
      alert("Gagal menambahkan organisasi. Silakan coba lagi.");
    }
  };
